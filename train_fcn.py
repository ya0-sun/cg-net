...
weight_path = 'weights/fbg_both_insar.h5' # weight name

# ************************ training scheme *************************
batch_size = 5
epochs = 40
lr = 2e-3 #2e-4, 2e-5 !!!!!!!!!!!!!!!!!!!!!! if loss is large (11.xxx), reduce 10
...
test_loss, test_acc = model.evaluate([np.concatenate([X_val1, X_val2], -1), X_val2], y_val)
print(test_loss)
print(test_acc)
